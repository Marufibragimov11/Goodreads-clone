...
class BookTestCase(TestCase):
    ...
    def test_books_list(self):
        ...
        book2 = Book.objects.create(title="Book2", description="Description2", isbn=1123141)
        book3 = Book.objects.create(title="Book3", description="Description3", isbn=1412411)
    ...
    def test_search_book(self):
        ...
        book2 = Book.objects.create(title="Guide", description="Description2", isbn=1123141)
        book3 = Book.objects.create(title="Shoe Dog", description="Description3", isbn=1412411)
...
class BookReviewTestCase(TestCase):
    def test_add_review(self):
        ...
        user = CustomUser.objects.create(
            username="Marufjon", first_name="Maruf", last_name="Ibragimov", email="admin@gmail.com"
        )
